...
export default function ShopPage() {
    ...
    //             const res = await fetch(query ? `/api/customer/catsection?${query}` : `/api/customer/catsection`)

    //             const data = await res.json()
    //             setProducts(data.products || []);
    //             setFilterOptions(data.filterOptions || { categories: [], brands: [], sizes: [], colors: [] });
    //         } catch (error) {
    //             console.log(error);
    //             setProducts([]);
    //         } finally {
                                        ...
                                        <div className="aspect-[4/5] overflow-hidden relative bg-[hsl(40,20%,95%)]">
                                            ...
                                            {product.salePercentage > 0 && (
                                                <span
                                                    ...
                                                    style={{
                                                        background: "linear-gradient(135deg, hsl(15,85%,60%), hsl(25,85%,55%))",
                                                ...
                                                <div className="flex gap-1.5 mt-0.5">
                                                    {product.colors.slice(0, 5).map((color) => (
                                                        <span
                                                            ...
                                                            style={{ background: color.hex, border: "1.5px solid hsl(40,20%,82%)" }}
                                                        />
                                                    ))}
                                            ...
                                            <div className="mt-auto flex items-end justify-between pt-2">
                                                ...
                                                {product.stock <= 5 && product.stock > 0 && (
                                                    <span
                                                        ...
                                                        style={{ background: "hsl(38,95%,50%,0.1)", color: "hsl(38,95%,40%)" }}
                                                    >
                                                        {product.stock} left
                                                    </span>
                                                )}
