...
// import { RiFilterLine, RiCloseLine, RiArrowDownSLine, RiFireLine, RiGridFill, RiListCheck, RiSparklingLine, } from "react-icons/ri";
...
//             console.log("API products333333:", data.products?.length);
...
//     }, []);
//     useEffect(() => {
//         console.log("loading22222:", loading);
//         console.log("products length2222222:", products?.length);
//     }, [loading, products]);
...
//             {/* Body */}
//             <div className="mx-auto max-w-screen-xl px-4 py-8 sm:px-6  border-4 border-red-500">
...
//                     {/* Product Grid */}
//                     <div className="flex-1 min-w-0 border-6 border-blue-700">

//                         {/* Active filter chips */}
//                         {activeFilterCount > 0 && (
//                             <div className="mb-5 flex flex-wrap gap-2 0">
...
//                                         className="flex items-center gap-1.5 rounded-full px-3 py-1 text-xs font-semibold"
//                                         style={{
//                                             background: "hsl(174,62%,38%,0.1)", color: "hsl(174,62%,35%)",
//                                             border: "1px solid hsl(174,62%,38%,0.25)"
//                                         }}>
//                                         {b} <RiCloseLine />
//                                     </button>
...
//                                     <p className="text-sm font-medium tracking-wide text-red-400">  Failed to fetch products</p>
//                                 </div>)
//                                 : 
...
//                                             <p className="font-semibold text-[hsl(220,20%,15%)]">No products found
    ...
    const fetchProducts = useCallback(async (f: Filters) => {
        ...
        try {
            ...
            f.categories.forEach((cat) =>
                params.append("category", slugify(cat))
            );
            ...
            f.colors.forEach((color) =>
                params.append("color", slugify(color))
            );
