...
import {
  ...
  getAdminBanners,
  uploadAdminBanners,
} from "@/components/admin/settings/api";
    ...
    <div className="min-h-screen">
      <div className="mx-auto max-w-[1600px] space-y-8">
        ...
        <AdminHero
          ...
          rightIcon={
            <RiSparklingLine className="text-lg text-fuchsia-300" />
          } />

        {/* Content */}
        <div className="grid gap-7 2xl:grid-cols-[380px_1fr]  items-start">
          ...
          <div className="rounded-[30px]   bg-[#111827]/70 p-5 shadow-2xl backdrop-blur-xl">
            ...
            <div className="space-y-5">
              ...
              <label
                ...
                className="group flex cursor-pointer flex-col items-center justify-center gap-4 rounded-[28px] border 
                border-dashed border-white/10 bg-[#0B1120]/70 p-10 transition-all duration-300 hover:border-fuchsia-500/30 hover:bg-fuchsia-500/[0.03]"
              >
            ...
            {loading ? (
              ...
              <div className="flex flex-col items-center gap-5 py-24">
                ...
                <div className="text-center">
                  ...
                  <p className="mt-1 text-sm text-zinc-500">
                    Upload your first banner to begin
                  </p>
                </div>
              </div>
            ) : (
