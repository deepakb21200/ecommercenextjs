...
// export default function CustomerCartItems() {
//   const { user } = useAuthStore();
//   const isSignedIn = !!user;

//   const { cart, increase, decrease, remove, setOpen } =
//     useCustomerCartAndCheckoutStore((s) => s);
...
//           className="flex gap-4 border rounded-xl p-3 shadow-sm"
//         >
//           <img
//             src={item.image}
