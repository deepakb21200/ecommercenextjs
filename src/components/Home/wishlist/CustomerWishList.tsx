...
//   const { isOpen, setOpen, items, removeItem } =
//     useCustomerWishlistStore();
...
//                   />
//                 ) : (
//                   <div className="w-[70px] h-[90px] bg-gray-200 flex items-center justify-center text-xs">
//                     No Image
//                   </div>
//                 )}
...
//                       className="px-3 py-1 bg-red-500 text-white rounded-md text-sm flex items-center gap-1"
//                     >
//                       <FaTrash /> Remove
//                     </button>
//                   </div>
...
export default function CustomerWishlistDialog() {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm">
      <div className="w-full max-w-xl bg-white rounded-2xl shadow-2xl max-h-[90vh] flex flex-col overflow-hidden">
