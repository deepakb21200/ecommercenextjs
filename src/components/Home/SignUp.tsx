...
// import { RiLockLine, RiUserLine, RiMailLine, RiEyeLine, RiEyeOffLine, RiSparklingLine } from "react-icons/ri";
...
//             style={{ background: "linear-gradient(135deg, hsl(15, 85%, 60%), hsl(25, 85%, 55%))" }}
//           >
...
//                   }}
//                   onFocus={(e) => {
//                     e.target.style.borderColor = "hsl(15, 85%, 60%)";
//                     e.target.style.boxShadow = "0 0 0 3px hsl(15, 85%, 60%, 0.1)";
//                   }}
//                   onBlur={(e) => {
...
//               }}
//               onMouseEnter={(e) => {
//                 if (!loading) (e.target as HTMLElement).style.background = "hsl(15, 85%, 52%)";
//               }}
//               onMouseLeave={(e) => {
