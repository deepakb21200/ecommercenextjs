...
export type OrderType = {
  ...
  stripePaymentIntentId: string; // ✅ razorpayOrderId ki jagah
  paymentId?: string;
  paidAt?: Date | null;
...
const OrderSchema = new Schema<OrderType>(
  {
    ...
    orderStatus: {
      type: String,
      enum: ["placed", "shipped", "delivered", "returned"] satisfies OrderStatus[],
      default: "placed",
    },
    stripePaymentIntentId: { // ✅ razorpayOrderId ki jagah
      type: String,
      required: true,
      trim: true,
    },
